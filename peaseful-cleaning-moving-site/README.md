...
- Current build marker: 2026-07-28-logo-refresh
...
- http://localhost:8000/assets/images/Scottyupdatedlogo.png?v=20260728-1
...
4. Confirm the custom domain is set to peacefulcleaningmoving.com.
...
```text
assets/images/Scottyupdatedlogo.png?v=20260728-1
```
...
- Website links should use https://peacefulcleaningmoving.com/.
